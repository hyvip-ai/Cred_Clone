        ...
        <OwlCarousel className="owl-theme" loop items={1} autoplay={true}>
          ...
          <div className={`item ${classes.item}`}>
            <h4>
              ...
              payment worries out of my mind"
            </h4>
          ...
          <div className={`item ${classes.item}`}>
            <h4>
              ...
              cc bills with a single click. love the experience."
            </h4>
            <p>pushpalatha a</p>
          </div>
          <div className={`item ${classes.item}`}>
            <h4>
              "great app, paying dues of credit card was never that much easy
              and fast. few more rewarding features also available there like
              showing credit score, can easily pay rent, getting cashback
              whenever paying cc dues. lots more. i really loves cred."
            </h4>
            <p>sanjeev kataria</p>
          </div>
        </OwlCarousel>
