  ...
  return (
    <div className={`${classes.mobile_bg}`} ref={ref}>
      <div className={classes.wrapper}>
        <div
          className={`${classes.mobile_img} ${classes.mobile_img_1} mobile_img`}
          id="left2"
        >
          <img
        ...
        <div
          className={`${classes.mobile_img} ${classes.mobile_img_2} mobile_img`}
          id="left1"
        >
          <img
        ...
        <div
          className={`${classes.mobile_img} ${classes.mobile_img_3} mobile_img`}
          id="middle"
        >
          <img
        ...
        <div
          className={`${classes.mobile_img} ${classes.mobile_img_4} mobile_img`}
          id="right1"
        >
          <img
        ...
        <div
          className={`${classes.mobile_img} ${classes.mobile_img_5} mobile_img`}
          id="right2"
        >
          <img
